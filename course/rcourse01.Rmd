...
investigando os demais argumentos.
...
apply(X = da[, c("idade", "imc", "hdl")], MARGIN = 2, FUN = mean)

# Mínino, 1 quartil, mediana, média, 3º quartil e máximo
apply(X = da[, c("idade", "imc", "hdl")], MARGIN = 2, FUN = summary)

# Mínino, 1 quartil, mediana, média, 3º quartil e máximo
lapply(X = da[, c("idade", "imc", "hdl")], FUN = summary)

# Mínino, 1 quartil, mediana, média, 3º quartil e máximo
sapply(X = da[, c("idade", "imc", "hdl")], FUN = summary)

#-------------------------------------------
# Agora médias estratificadas por sexo
tapply(X = da[, "idade"], INDEX = da[, "sexo"], FUN = mean)
tapply(X = da[, "imc"], INDEX = da[, "sexo"], FUN = mean)
tapply(X = da[, "hdl"], INDEX = da[, "sexo"], FUN = mean)
